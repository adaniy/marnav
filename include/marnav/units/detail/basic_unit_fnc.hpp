...
namespace units
{
template <class U, class R> constexpr basic_unit<U, R> floor(const basic_unit<U, R> & v) noexcept
{
	using std::floor;
...
template <class U, class R> constexpr basic_unit<U, R> round(const basic_unit<U, R> & v) noexcept
{
	using std::round;
