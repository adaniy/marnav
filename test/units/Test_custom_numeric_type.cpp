...
{
	using half_meters = marnav::units::basic_unit<marnav::units::basic_meter<custom::number>, std::ratio<1, 2>>;
	using quarter_meters
		= marnav::units::basic_unit<marnav::units::basic_meter<custom::number>, std::ratio<1, 4>>;
